...
import { CdkSecurityStack } from './cdk-security-stack';
import {AwsSolutionsChecks, NagSuppressions} from "cdk-nag";

const app = new App();

const stack = new CdkSecurityStack(app, 'cdk-security', {
    env: {
...
// Um AwsSolutionsChecks auf Stack-Level nur für diesen Stack zu aktivieren...
Aspects.of(stack).add(new AwsSolutionsChecks())

// Für den Stack werden folgende Checks unterdrückt...
